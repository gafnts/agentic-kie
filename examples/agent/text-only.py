...
def main() -> None:
    ...
    claude_extractor = AgenticExtractor(model=claude, schema=NDA)
    gemini_extractor = AgenticExtractor(model=gemini, schema=NDA)
    gpt_extractor = AgenticExtractor(model=gpt, schema=NDA)
